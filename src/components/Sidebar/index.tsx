      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <Link href="/">
          {/* <Image
            ...
            priority
          /> */}
          <span className="font-bold text-[#A0FD32]">Portfolify</span>
        </Link>
        ...
        >
          <svg
            className="fill-current hover:text-[#A0FD32]"
            width="20"
            height="18"
            viewBox="0 0 20 18"
            fill="none"
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        href="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out hover:bg-[#A0FD32] hover:text-white dark:text-white dark:hover:bg-[#A0FD32] ${
                          (pathname === "/" ||
                            pathname.includes("dashboard")) &&
                          "bg-[#A0FD32] text-white dark:bg-meta-4 "
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
                      ...
                      >
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-[#A0FD32] ${
                                pathname === "/" && "text-black"
                              }`}
                            >
                              My Portfolios
              ...
              <li className="hidden">
                <Link
                  href="/calendar"
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out hover:bg-[#A0FD32] hover:text-white dark:hover:bg-meta-4 ${
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        href="#"
                        className={`group relative flex hidden items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out hover:bg-[#A0FD32] hover:text-white dark:hover:bg-meta-4 ${
                          (pathname === "/forms" ||
