...
const Footer = () => {
  ...
  return (
    <div className="pt-12">
      <footer id="footer" className="dark:bg-gray-900 relative z-50 pt-24">
        <div className=" border-gray-200 dark:border-gray-700 border-b border-t py-16">
                  ...
                  <ul>
                    <li>
                      <Link href="/" legacyBehavior>
                        <a className="hover:text-brand dark:hover:text-brand text-gray-800 dark:text-gray-50 text-xs leading-none lg:text-sm">
                          Components
                        </a>
                      </Link>
                    </li>
                    ...
                    <li className="mt-6">
                      <a
                        href="/"
                        className="hover:text-brand dark:hover:text-brand text-gray-800 dark:text-gray-50 text-xs leading-none lg:text-sm"
                      >
                        Documentation
                      </a>
                    </li>
              ...
              <div className="flex w-full lg:w-1/2">
                ...
                <div className="flex w-full flex-col justify-between px-6 lg:w-1/2">
                  <div className="mb-6 flex items-center">
                    <a href="/">
                      <div className="text-gray-800 dark:text-gray-50 hover:text-brand dark:hover:text-brand cursor-pointer ">
                        <svg
                    ...
                    <a href="/">
                      <div className="pl-4">
                        <svg
                          className="footer-icon feather feather-twitter text-gray-800 dark:text-gray-50 hover:text-brand dark:hover:text-brand cursor-pointer "
                          xmlns="http://www.w3.org/2000/svg"
                          width={24}
                          height={24}
                          viewBox="0 0 24 24"
                  ...
                  <div className="relative w-36">
                    {mode == "auto" && (
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="text-gray-700 dark:text-gray-50 icon icon-tabler icon-tabler-device-laptop absolute inset-0 m-auto ml-3"
                        width={20}
                        height={20}
                        viewBox="0 0 24 24"
                        strokeWidth="1.5"
                    ...
                    {mode == "light" && (
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="text-gray-700 dark:text-gray-50 icon icon-tabler icon-tabler-brightness-up absolute inset-0 m-auto ml-3"
                        width={20}
                        height={20}
                        viewBox="0 0 24 24"
                        strokeWidth="1.5"
                    ...
                    {mode == "dark" && (
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="text-gray-700 dark:text-gray-50 icon icon-tabler icon-tabler-moon absolute inset-0 m-auto ml-3"
                        width={20}
                        height={20}
                        viewBox="0 0 24 24"
                        strokeWidth="1.5"
                    ...
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="text-gray-700 dark:text-gray-50 icon icon-tabler icon-tabler-chevron-down pointer-events-none absolute inset-0 m-auto mr-3"
                      width={16}
                      height={16}
                      viewBox="0 0 24 24"
                      strokeWidth="1.5"
                    ...
                    <select
                      ...
                      className="border-gray-700 dark:border-gray-50 dark:bg-gray-900 dark:text-gray-50 flex h-12 w-full appearance-none items-center rounded border py-2 pl-10 text-sm leading-5 focus:outline-none"
                    >
        ...
        <div className="flex flex-col items-center justify-center py-16">
          ...
          <p className="text-gray-900 dark:text-gray-50 mt-6 text-xs leading-none lg:text-sm">
            @2024 Portfolify CMS. All Rights Reserved.
          </p>
        </div>
      </footer>
    </div>
